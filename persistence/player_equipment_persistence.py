...
def get_player_equipment(player_id: int, equipment_slot_id: int) -> PlayerEquipment:
    ...
    statement = select_player_equipment_table
...
def get_all_player_equipment(player_id: int) -> List[PlayerEquipment]:
    ...
    stmt_args = (player_id,)
    statement = select_all_player_equipment_table
    cursor_obj.execute(statement, stmt_args)
...
def insert_player_equipment(equipment: PlayerEquipment):
    stmt = insert_player_equipment_table
