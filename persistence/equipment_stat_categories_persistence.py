...
select_equipment_stat_categories_table = (
    "SELECT * FROM %s WHERE unique_id = ?" % equipment_stat_categories_table
)
select_all_equipment_stat_categories_table = (
    "SELECT * FROM %s" % equipment_stat_categories_table
)
...
def get_equipment_stat_category(unique_id: int) -> EquipmentStatCategory:
    ...
    stmt_args = (unique_id,)
    statement = select_equipment_stat_categories_table
...
def get_all_equipment_stat_categories() -> List[EquipmentStatCategory]:
    ...
    statement = select_all_equipment_stat_categories_table
