...
from persistence.damage_type_persistence import get_all_damage_types
from persistence.dto.move import Move
...
def populate_moves_table():
    ...
    for item in data:
        if not get_move(item["unique_id"]):
            ...
            scaling_equipment_stat_id = convert_name_to_id(
                eq_stat_cats, item["scaling_equipment_stat"]
            )
